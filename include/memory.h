...
#define LoROM_SRAM_BANKS (uint8_t[]){ 0x70, 0x7D }
#define LoROM_SRAM_BYTES (uint16_t[]){ 0x0000, 0x7FFF }
#define LoROM_SRAM_SIZE MEMORY_AREA(LoROM_SRAM_BANKS[0], LoROM_SRAM_BYTES[0], LoROM_SRAM_BANKS[1], LoROM_SRAM_BYTES[1])
